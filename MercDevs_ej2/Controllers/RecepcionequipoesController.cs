...
namespace MercDevs_ej2.Controllers
{
    public class RecepcionequipoesController : Controller
    {
        ...
        // GET: Recepcionequipos/ByCliente/5
        public async Task<IActionResult> ByCliente(int? id)
        {
            if (id == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> EquiposRecepcionados(int? idCliente)
        {
            if (idCliente == null)
            {
                return NotFound();
        ...
        public async Task<IActionResult> UpdateEstado(int id)
        {
            ...
            // Actualizar el estado del servicio asociado
            equipo.IdServicioNavigation.Estado = "Finalizado";
            await _context.SaveChangesAsync();

            return RedirectToAction("Details", new { id = equipo.Id });
        }
